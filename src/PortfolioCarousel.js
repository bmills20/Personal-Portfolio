...
function PortfolioCarousel (){
    ...
    return(
        <Carousel infiniteLoop useKeyboardArrows autoPlay width={"50vw"} showStatus={false} showThumbs={false}>
            <Card className="bg-dark text-white mb-3 hoverCard" onMouseEnter={() => toggleStaticPic(!show)} onMouseLeave={() => toggleStaticPic(!show)}>
            ...
            <Card className="bg-dark text-white mb-3 hoverCard" onMouseEnter={() => toggleStaticPic2(!show2)} onMouseLeave={() => toggleStaticPic2(!show2)}>
            ...
            <Card className="bg-dark text-white mb-3 hoverCard">
